...
android {
    namespace = "com.chartboost.mediation.googlebiddingadapter"
    compileSdk = 34
    ...
    defaultConfig {
        ...
        android.defaultConfig.versionName = System.getenv("VERSION_OVERRIDE") ?: "5.25.5.0.0"
    ...
    publishing {
        publications {
            register<MavenPublication>("remoteRelease") {
                ...
                val adapterName = "google-bidding"
                ...
                pom {
                    name.set("Chartboost Mediation Adapter Google Bidding")
